...
public class ExtentManager {
    ...
    public static ThreadLocal<ExtentReports> getExtent() { return extent; }

    public static void setExtent(ExtentReports extent) { getExtent().set(extent); }
    ...
    public static void addExecutionDetails_ExtentReport() { getExtent().get().flush(); }
}
